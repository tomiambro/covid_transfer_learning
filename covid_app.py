...
if __name__=='__main__':
    ...
    st.write("Disclaimer! This is just a proof of concept. It is not, by any mean, a medical diagnosis and should not be relied upon without consulting a medic or health specialist.")
